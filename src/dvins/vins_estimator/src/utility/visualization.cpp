...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_track = n.advertise<sensor_msgs::Image>("track_img", 1000);
    pub_key_poses = n.advertise<visualization_msgs::Marker>("key_poses", 1000);
    pub_camera_pose = n.advertise<nav_msgs::Odometry>("cam_pose", 1000);
...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, const Eigen::Vector3d &W, const std_msgs::Header &header)
{
...
void pubTrackImage(const cv::Mat& img, const std_msgs::Header &header)
{
  sensor_msgs::ImagePtr img_msg = cv_bridge::CvImage(header, "bgr8", img).toImageMsg();
  pub_track.publish(img_msg);
}
