...
3.1.0 Open three terminals, launch the vins_estimator , rviz and play the bag file respectively. Take Critical HIT for example. 

Pinhole Camera
```
    roslaunch vins_estimator uav_pinhole.launch 
    rosbag play YOUR_DATA.bag
```
Fisheye Camera
```
    roslaunch vins_estimator uav_fisheye.launch 
    rosbag play YOUR_DATA.bag
```
